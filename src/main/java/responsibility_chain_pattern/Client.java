 ...
 * 
 * 　　需要把每位领导的处理独立出来，实现成单独的职责处理对象，然后为它们提供一个公共的、抽象的父职责对象，这样就可以在客户端来动态地组合职责链，
 * 实现不同的功能要求了。
 * </pre>
 * 
 * <p>
 * 其他实现可以参考：http://blog.csdn.net/crave_shy/article/details/21020507
 */
public class Client {

	public static void main(String[] args) {
		// 先要组装责任链 处理流程是：h3->h2->h1
